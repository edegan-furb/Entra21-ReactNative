...
INSERT INTO
    Animais (IDAnimal, Nome, Especie)
VALUES (1, 'Dog', 'Cachorro'), (2, 'Cat', 'Gato'), (3, 'Fox', 'Raposa'), (4, 'Rabbit', 'Coelho'), (5, 'Rat', 'Rato');
...
INSERT INTO
    Proprietarios (IDProprietario, Nome, Telefone)
VALUES (1, 'Maria', '123-456-7890'), (2, 'João', '234-567-8901'), (3, 'Ana', '345-678-9012'), (4, 'Carlos', '456-789-0123'), (5, 'Julia', '567-890-1234');
...
VALUES (1, 1, 1, '2023-11-02'), (2, 2, 2, '2023-11-03'), (3, 3, 3, '2023-11-04'), (4, 4, 4, '2023-11-05'), (5, 5, 5, '2023-11-06');
...
UPDATE Animais SET Nome = 'Ratazana' WHERE IDAnimal = 5;
...
DELETE FROM Consultas WHERE IDConsulta = 5;
...
FROM Consultas
WHERE
    DataConsulta = '2023-11-02';

-- Ordene os animais em ordem alfabética de nome.

SELECT Nome, Especie FROM Animais ORDER BY Nome ASC;
